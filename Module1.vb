Module Module1
    ...
    'Public Connect_String As String = "Driver={Microsoft Access Driver (*.mdb)};DBQ=C:\vbProjects\CustomerInvoice\bin\Data\CustomerInvoiceDb.mdb"
    Public Connect_String As String = "Driver={Microsoft Access Driver (*.mdb)};DBQ=" & appPath.Replace("file:\", "") & "\Data\ScaleAppDb.mdb"

    Public MyConnection As New Odbc.OdbcConnection(Connect_String)
    Public useradmin As Boolean = True
    Public MyCommand As Odbc.OdbcCommand
    Public trans As Odbc.OdbcTransaction
    Public sqlstringM As String
